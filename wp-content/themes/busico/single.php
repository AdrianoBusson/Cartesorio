...
if (!empty($custom_page_layout && $use_custom_layout)) {
	...
	$layout = $busico['single_page_layout'];
} else {
...
?>
	<?php echo esc_html($busicoObj->busico_breadcrumb_bridge()); ?>
	<div class="content-block post-details-page">
		<div class="container">
			<div class="row justify-content-center">

				<?php if ('left-sidebar' == $layout &&  is_active_sidebar('busico_blog_sidebar')) : ?>
					<div class="col-xl-4 col-lg-5 col-md-10 left-sidebar"><?php get_sidebar('busico_blog_sidebar'); ?></div>
				...
				<div class="col-xl-8 col-lg-7 col-md-12">
					<main id="primary" class="site-main">
						...
						the_post_navigation(
							array(
								'prev_text' => '<span class="nav-subtitle">' . esc_html__('Previous post:', 'busico') . '</span> <span class="nav-title">' . $prev_icon . ' %title</span>',
								'next_text' => '<span class="nav-subtitle">' . esc_html__('Next post:', 'busico') . '</span> <span class="nav-title">%title ' . $next_icon . '</span>',
							)
						);
				...
				<?php if ('right-sidebar' == $layout && is_active_sidebar('busico_blog_sidebar')) : ?>
