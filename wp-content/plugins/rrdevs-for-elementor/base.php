	...
	*/
	...
	public function init_widgets() {
		...
		*/
		...
		require_once( RRDEVS_WIDGET_EXTENSIONS . 'floting-effect.php' );
		...
		require_once( RRDEVS_WIDGET_DIR . 'FeatureImage/widget.php' );
		require_once( RRDEVS_WIDGET_DIR . 'ListGroup/widget.php' );
		require_once( RRDEVS_WIDGET_DIR . 'Search/widget.php' );
	}
}
