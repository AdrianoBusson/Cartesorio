    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .rrdevs-addons--tab-menu ul.tabs>li .rrdevs-addons-tab-icon'  => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'options'      => [
                    ...
                    'justify'  => [
                        'title' => __( 'justify', 'rrdevs-addons' ),
                        'icon'  => 'fa fa-align-justify',
                    ],
                ],
                'devices'      => ['desktop', 'tablet', 'mobile'],
                'selectors' => [
                    '{{WRAPPER}} .rrdevs-addons--tab-menu ul.tabs>li' => 'justify-content: {{VALUE}}',
                ],
                'toggle'       => true,
            ]
        );
