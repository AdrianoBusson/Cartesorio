 ...
 * @since 1.0.0
 */
class RRdevs_Featured_Image extends Widget_Base {
    /**
     * Get widget name.
     *
    ...
    public function get_title() {
        return __( 'Featured Image', 'rrdevs-addons' );
    }
    /**
     * Get widget icon.
     *
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            'space',
            [
                'label'          => __( 'Max Width', 'rrdevs-addons' ),
                'type'           => Controls_Manager::SLIDER,
                'default'        => [
                    'unit' => '%',
                ],
        ...
        $this->add_responsive_control(
            'object-fit',
            [
                'label'     => __( 'Object Fit', 'rrdevs-addons' ),
                ...
                'options'   => [
                    ...
                    'fill'    => __( 'Fill', 'rrdevs-addons' ),
                    'cover'   => __( 'Cover', 'rrdevs-addons' ),
                    'contain' => __( 'Contain', 'rrdevs-addons' ),
                ],
                'default'   => '',
                'selectors' => [
        ...
        $this->add_control(
            'hover_animation',
            [
                'label' => __( 'Hover Animation', 'rrdevs-addons' ),
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __( 'Caption', 'rrdevs-addons' ),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'caption_source!' => 'none',
                ],
...
$widgets_manager->register_widget_type( new \RRdevs_Addons\Widgets\RRdevs_Featured_Image() );