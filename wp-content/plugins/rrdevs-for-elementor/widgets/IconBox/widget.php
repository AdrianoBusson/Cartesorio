...
class RRdevs_Icon_Box extends Widget_Base {
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			'enable_bottom_number',
			[
				'label' => __('Show Number', 'rr-addons'),
		...
		$this->add_control(
			...
			[
				...
				'condition' => ['enable_bottom_number' => 'yes']
			]
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .rrdevs-addons-feature-box-item' => 'text-align: {{VALUE}}',
				],
				'default' => 'center',
				'toggle' => true,
			]
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .rrdevs-addons-feature-number' => 'color: {{VALUE}}',
				],
			]
		);
		$this->add_control(
		...
		$this->add_group_control(
			...
			[
				...
				'label' => __('Number Typography', 'rrdevs-addons'),
				'selector' => '{{WRAPPER}} .rrdevs-addons-feature-number',
			]
		);
		$this->add_responsive_control(
			'number_box_size',
			[
				'label' => __('Number Box Size', 'rrdevs-addons'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px', '%'],
				'range' => [
					'px' => [
				...
				'selectors' => [
					'{{WRAPPER}}  .rrdevs-addons-feature-number' => 'width: {{SIZE}}{{UNIT}}; height: {{SIZE}}{{UNIT}};',
				],
				'condition' => ['enable_bottom_number' => 'yes']
			]
		);
		$this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .rrdevs-addons-feature-number' => 'background: {{VALUE}}',
                ],
            ]
        );
		$this->add_control(
    ...
    $this->add_responsive_control(
            ...
            [
                'label'      => __( 'Number Border Radius', 'rrdevs-addons' ),
                ...
                'selectors'  => [
                    '{{WRAPPER}} .rrdevs-addons-feature-number' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
                ]
            ]
        );
	$this->add_responsive_control(
		...
		$this->add_responsive_control(
            'number_padding',
            [
                'label' => __('Number Padding', 'upmedix'),
                'type' => \Elementor\Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors' => [
                    '{{WRAPPER}} .rrdevs-addons-feature-number' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
		$this->add_responsive_control(
		...
		// 	Group_Control_Background::get_type(),
		// 	[
		// 		'name'      => 'icon_box_background_gradient',
		// 		'types'     => [ 'classic', 'gradient' ],
		// 		'fields_options'  => [
		// 			'background'  => [
		// 				'default' => 'classic'
		...
		<div class="rrdevs-addons-feature-box-item <?php printf("rrdevs-addons-feature-icon-%s rrdevs-addons-icon-position-%s",  esc_attr( $settings['content_align'] ), esc_attr( $settings['position'] ) ) ?>">
			...
			<div class="rrdevs-addons-feature-icon-wrap <?php printf("icon-background-%s align-items-%s", esc_attr( $enable_iconb_box ) , esc_attr( $settings['icon_align'] ) ) ?>">
				<span class="rrdevs-addons-feature-icon icon-type-<?php echo $settings['icon_type'] ?>">
					...
					?>
					<?php if(!empty(  $settings['bottom_number'] )): ?>
						 <h6 class="rrdevs-addons-feature-number"><?php echo $settings['bottom_number'] ?></h6>
					<?php endif; ?>
				</span>
