...
class RRdevs_Modal_Popup extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'   => [
					'{{WRAPPER}} .rrdevs-modal-wrapper .rrdevs-midal-btn-icon.modal-icon-left' => 'margin-right: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .rrdevs-modal-wrapper .rrdevs-midal-btn-icon.modal-icon-right' => 'margin-left: {{SIZE}}{{UNIT}};'
				],
				'condition'   => [
                    'rrdevs_modal_btn_icon[value]!' => ''
                ]
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'   => [
					'{{WRAPPER}} .rrdevs-modal-wrapper .rrdevs-midal-btn-icon i' => 'font-size: {{SIZE}}{{UNIT}};',
					'{{WRAPPER}} .rrdevs-modal-wrapper .rrdevs-midal-btn-icon svg' => 'width: {{SIZE}}{{UNIT}};',
				],
		...
		$this->start_controls_tab( 'rrdevs_modal_btn_icon_color_normal_tab', 
			[ 
				'label' => esc_html__( 'Normal', 'rrdevs-addons' )
			] 
		);
		$this->add_control(
			'rrdevs_modal_btn_icon_color_normal',
			[
				'label'     => __( 'Color', 'rrdevs-addons' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#ffffff',
				'selectors' => [
					'{{WRAPPER}} .rrdevs-modal-wrapper span.rrdevs-midal-btn-icon' => 'color: {{VALUE}};'
				]
			]
		);

		$this->add_control(
			'rrdevs_modal_btn_icon_background_normal',
			[
				'label'     => __( 'Background Color', 'rrdevs-addons' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#4243DC',
				'selectors' => [
					'{{WRAPPER}} .rrdevs-modal-wrapper span.rrdevs-midal-btn-icon' => 'background-color: {{VALUE}};'
				]
			]
		);
		
		$this->add_control(
			'rrdevs_modal_btn_icon_enable_fixed_width_height',
			[
				'label' => __( 'Enable Fixed Height & Width?', 'rrdevs-addons' ),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __( 'Show', 'rrdevs-addons' ),
		...
		$this->add_control(
			'rrdevs_modal_btn_icon_fixed_width_height',
			[
				'label' => __( 'Fixed Height & Width', 'rrdevs-addons' ),
				'type' => Controls_Manager::POPOVER_TOGGLE,
				'label_off' => __( 'Default', 'rrdevs-addons' ),
				...
				'default' => 'yes',
				'condition' => [
					'rrdevs_modal_btn_icon_enable_fixed_width_height' => 'yes'
				]
			]
		);
		...
		$this->add_responsive_control(
			'rrdevs_modal_btn_icon_fixed_width',
			[
				'label'      => esc_html__( 'Width', 'rrdevs-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				...
				'selectors'  => [
					'{{WRAPPER}} .rrdevs-modal-wrapper span.rrdevs-midal-btn-icon' => 'width: {{SIZE}}{{UNIT}};'
		...
		$this->add_responsive_control(
			'rrdevs_modal_btn_icon_fixed_height',
			[
				'label'      => esc_html__( 'Height', 'rrdevs-addons' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px', '%' ],
				...
				'selectors'  => [
					'{{WRAPPER}} .rrdevs-modal-wrapper span.rrdevs-midal-btn-icon' => 'height: {{SIZE}}{{UNIT}};'
				],
				'condition' => [
					'rrdevs_modal_btn_icon_enable_fixed_width_height' => 'yes'
				]
		...
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'               => 'rrdevs_modal_btn_icon_border_normal',
				'selector'           => '{{WRAPPER}} .rrdevs-modal-wrapper span.rrdevs-midal-btn-icon'
			]
		);

		$this->add_responsive_control(
			'rrdevs_modal_btn_icon_radius',
			[
				'label'      => __( 'Border Radius', 'rrdevs-addons' ),
				'type'       => Controls_Manager::DIMENSIONS,
				'size_units' => [ 'px', '%' ],
				...
				'selectors'  => [
					'{{WRAPPER}} .rrdevs-modal-wrapper span.rrdevs-midal-btn-icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				]
			]
		);

		$this->add_responsive_control(
			'rrdevs_modal_btn_icon_padding',
			[
				'label'        => __( 'Padding', 'rrdevs-addons' ),
				'type'         => Controls_Manager::DIMENSIONS,
				'size_units'   => [ 'px', '%' ],
				...
				'selectors'    => [
					'{{WRAPPER}} .rrdevs-modal-wrapper span.rrdevs-midal-btn-icon' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				]
			]
		);
	...
	$this->start_controls_tab( 'rrdevs_modal_btn_icon_color_hover_tab', [ 'label' => esc_html__( 'Hover', 'rrdevs-addons' ) ] );

		$this->add_control(
			'rrdevs_modal_btn_icon_color_hover',
			[
				'label'     => __( 'Text Color', 'rrdevs-addons' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#fff',
				'selectors' => [
					'{{WRAPPER}} .rrdevs-modal-wrapper span.rrdevs-midal-btn-icon:hover' => 'color: {{VALUE}};'
				]
			]
		);

		$this->add_control(
			'rrdevs_modal_btn_icon_background_hover',
			[
				'label'     => __( 'Background Color', 'rrdevs-addons' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '#EF2469',
				'selectors' => [
					'{{WRAPPER}} .rrdevs-modal-wrapper span.rrdevs-midal-btn-icon:hover' => 'background-color: {{VALUE}};'
				]
			]
		);
		$this->add_group_control(
			Group_Control_Border::get_type(),
			[
				'name'     => 'rrdevs_modal_btn_icon_border_hover',
				'selector' => '{{WRAPPER}} .rrdevs-modal-wrapper span.rrdevs-midal-btn-icon:hover'
			]
		);
			...
			<div class="rrdevs-modal-wrapper">
				...
				<div class="rrdevs-modal-button <?php echo esc_attr( $overly ); ?>    rrdevs-modal-btn-fixed-width-<?php echo esc_attr($settings['rrdevs_modal_btn_enable_fixed_width_height']);?>">
					...
					<?php if( 'left' === $settings['rrdevs_modal_btn_icon_align'] && !empty( $settings['rrdevs_modal_btn_icon']['value'] ) ): ?>
							<span class="rrdevs-midal-btn-icon modal-icon-<?php echo esc_attr($settings['rrdevs_modal_btn_icon_align']);?>">
								<?php Icons_Manager::render_icon( $settings['rrdevs_modal_btn_icon'], [ 'aria-hidden' => 'true' ] ); ?> 
							</span>
						<?php endif; ?>

						<span> <?php	echo esc_html( $settings['rrdevs_modal_btn_text'] ); ?></span>

						<?php if( 'right' === $settings['rrdevs_modal_btn_icon_align'] && !empty( $settings['rrdevs_modal_btn_icon']['value'] ) ): ?>
							<span class="rrdevs-midal-btn-icon modal-icon-<?php echo esc_attr($settings['rrdevs_modal_btn_icon_align']);?>" >
								<?php Icons_Manager::render_icon( $settings['rrdevs_modal_btn_icon'], [ 'aria-hidden' => 'true' ] ); ?>
							</span>
						<?php endif; ?>
