(function( $ ) {
   ...
   $(document).ready( function() {
      ...
      // Show all / less toggler for field options and sponsorship notice | Modified from https://codepen.io/symonsays/pen/rzgEgY
      $('.asenha-field-with-options.field-show-more > .show-more, .asenha-sponsorship-nudge.nudge-show-more > .show-more').click(function(e) {
