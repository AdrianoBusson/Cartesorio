...
**Admin and Site Enhancements (ASE) v1.0.0** was released on October 17, 2022. Since then, there have been **52 _point_ releases** (e.g. 1.1.0 ) and **38 _patch_ releases** (e.g. 4.9.1). 
...
**More than 250 hours of dev time** have been spent on developing and mantaining this plugin. At v5.2.9 (released on June 27, 2023) and **4,000+ active installs**, there have been **4 (active)** [**monthly sponsorship**](https://bowo.io/asenha-sp-gth-chnlg) and **16** [**one-time sponsorship**](https://bowo.io/asenha-sp-ppl-chnlg).
...
> _"**Amazing solution, please dont stop the developing!**."_ ~[@malaga16](https://wordpress.org/support/topic/lots-of-features-clean-ui-for-free/)
...
* **[IMPROVED] Front-end public.js** will only be loaded if relevant modules that use it are enabled. Props to Martin M. for reporting the issue via the contact form at [bowo.io](https://bowo.io).
